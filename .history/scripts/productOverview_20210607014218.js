(function () {
  ...
  <div class="product-info-card">
    ...
    <div class="flex-row ">
        ...
        <p> <img src="https://pknar.github.io/SKW/assets/icons/productOverview/invert.png" /> ${selected.product.specifications.afmeting} cm</p>
    </div>
    <hr>
    <div class="flex-row price-row">
        <h3>€ ${selected.product.price}</h3>
        <img src = "https://pknar.github.io/SKW/assets/icons/productOverview/SharedScreenshot.png"/>
    </div>
    <hr>
    <div>
        <h4>Details</h4>
